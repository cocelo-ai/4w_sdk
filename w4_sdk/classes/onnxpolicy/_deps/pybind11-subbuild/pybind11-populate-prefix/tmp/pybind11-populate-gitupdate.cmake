...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.12.0"
  WORKING_DIRECTORY "/home/radxa/4w_sdk/onnxpolicy/_deps/pybind11-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/radxa/4w_sdk/onnxpolicy/_deps/pybind11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/radxa/4w_sdk/onnxpolicy/_deps/pybind11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
